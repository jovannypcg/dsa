...
import mx.jovannypcg.base.p23_mergesortedarray.Solution;
...
public class SolutionTest {
    ...
    @Test
    @DisplayName("boundary values at the constraint limits (+-10^9) merge correctly")
    void extremeValues() {
        Solution solution = new Solution();
        ...
        assertThat(nums1).containsExactly(-1000000000, -500000000, 500000000, 1000000000);
    }
    ...
    @Test
    @DisplayName("larger merge with m + n at a moderate size preserves sort order")
    void largerMerge() {
        Solution solution = new Solution();
