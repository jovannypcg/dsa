...
This is the mirror image of [Kth Largest Element in a Stream](../p059_kthlargestelementinastream): instead of tracking the top of the pool, the admissions office now wants to keep an eye on the lower end of the distribution — the kth *lowest* test score seen so far, updated in real time as new scores arrive.
